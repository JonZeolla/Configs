...
alias grepz="grep --exclude-dir=.venv --exclude-dir=.terraform --exclude-dir=.aws-sam --exclude-dir=.pytest_cache --exclude-dir=.web --exclude-dir=node_modules --exclude-dir=.mypy_cache --exclude=requirements.txt --exclude=uv.lock --exclude=package-lock.json"
function grepyml() {
